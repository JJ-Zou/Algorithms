...
import com.zjj.dubbo.rpc.common.utils.UrlUtils;
...
import static com.zjj.dubbo.rpc.common.constants.RegistryConstants.DYNAMIC_KEY;
import static com.zjj.dubbo.rpc.registry.Constants.REGISTRY_LOCAL_FILE_CACHE_ENABLED;
...
public abstract class AbstractRegistry implements Registry {
    ...
    public AbstractRegistry(URL url) {
        setUrl(url);
        if (url.getParameter(REGISTRY_LOCAL_FILE_CACHE_ENABLED, true)) {
            // 缓存url到本地文件
        }
    }
