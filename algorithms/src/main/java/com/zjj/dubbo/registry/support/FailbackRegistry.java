...
import static com.zjj.dubbo.registry.Constants.*;
...
//            retryTimer.newTimeout(newTask, retryPeriod, TimeUnit.MICROSECONDS);
    ...
    public void register(URL url) {
        if (!acceptable(url)) {
            log.debug("URL {} will not be registered to Registry. Registry {} does not accept com.zjj.service of this protocol type.",
                    url, url);
            return;
        }
        super.register(url);
