...
import com.zjj.dubbo.config.spring.beans.factory.annotation.ServiceClassPostProcessor;
...
public class RpcComponentScanRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        ...
        log.info("getPackagesToScan的数量为: {}.", packagesToScan.size());
    ...
    /**
     * 从metadata中获取含注解@RpcComponentScan的包
     *
    ...
    private Set<String> getPackagesToScan(AnnotationMetadata metadata) {
        ...
        if (annotationAttributes == null) {
            throw new IllegalStateException("RpcComponentScan package is null.");
        }
